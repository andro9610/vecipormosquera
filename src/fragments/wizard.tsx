...
export const Wizard = ({
    ...
    return (
        <section className="surface-organic mx-auto m-4 w-full max-w-4xl p-4 backdrop-blur md:p-8">
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="min-w-0">
                                <span className="block text-[11px] uppercase tracking-[0.15em] text-base-content/55">
