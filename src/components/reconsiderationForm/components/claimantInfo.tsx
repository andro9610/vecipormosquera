...
type ClaimantInfoProps = {
  ...
  onChangeField: (field: keyof ClaimantInfoType, value: string | boolean) => void;
};
...
export const ClaimantInfo = ({ value, onChangeField }: ClaimantInfoProps) => {
  ...
  const actuaComoSeleccionado = value.actuaComo ? "propietario" : "poseedor";
  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <div className="md:col-span-1">
          <label htmlFor="actuaComo" className="label">
            <span className="label-text">Actua como</span>
          </label>
          <div className="flex w-full items-start gap-3 flex-wrap sm:flex-nowrap">
            <label className="custom-option flex sm:w-1/2 flex-row items-start gap-3">
              <input
                ...
                name="actuaComo"
                className="radio radio-primary"
                checked={actuaComoSeleccionado === "propietario"}
                onChange={() => onChangeField("actuaComo", true)}
              />
              <span className="text-base font-medium">Propietario</span>
            </label>
            <label className="custom-option flex sm:w-1/2 flex-row items-start gap-3">
              <input
                type="radio"
                name="actuaComo"
                className="radio radio-primary"
                checked={actuaComoSeleccionado === "poseedor"}
                onChange={() => onChangeField("actuaComo", false)}
              />
              <span className="text-base font-medium">Poseedor</span>
            </label>
          </div>
        </div>
        <div className="md:col-span-1">
