            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div className="md:col-span-1">
                    ...
                    <select
                        ...
                        onChange={(event) => onChangeField('identificador', event.target.value)}
                    >
                        <option value="">- Seleccione una opcion -</option>
                        <option value="Matricula">Matricula Inmobiliaria</option>
                        <option value="CedulaCatastral">Cedula Catastral</option>
                    </select>
                </div>
                <div className="md:col-span-1">
                    <label htmlFor="numeroIdentificacion" className="label">
                        <span className="label-text font-semibold">Numero Identificador</span>
                    </label>
                    <input
